...
class Robowebsites(object):
    ...
    def update_data(self):
        robomarket = requests.get('https://robo.market').status_code
        opg_robokassa = requests.get('https://opg.robokassa.ru').status_code
        partner_robokassa = requests.get('https://partner.robokassa.ru').status_code
        my_robokassa = requests.get('https://my.robokassa.ru').status_code
        ...
        support_robokassa = requests.get('https://support.robokassa.ru/').status_code
